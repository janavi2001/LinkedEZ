    ...
    async def execute_linkedin_outreach(
        ...
        try:
            ...
            todos = [
                ...
                "  - A connection dialog will appear with options",
                "  - CRITICAL: You MUST click 'Add a note' button - DO NOT click 'Send without a note' or 'Send now'",
                "  - Look for the button that says 'Add a note' and click it to open the message field",
                "  - NEVER skip adding a note - always personalize the connection request",
