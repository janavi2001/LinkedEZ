    ...
    async def execute_linkedin_outreach(
        ...
        try:
            ...
            todos = [
                ...
                "  - A connection dialog popup will appear with several options",
                "  - ⚠️ CRITICAL RULE: DO NOT CLICK ANY 'SEND' BUTTON YET ⚠️",
                "  - STOP and look carefully at ALL buttons in the dialog",
                "  - You will see options like: 'Add a note' or 'Send without a note' or 'Send now'",
                "  - ❌ FORBIDDEN: NEVER click 'Send without a note' - this violates the requirement",
                "  - ❌ FORBIDDEN: NEVER click 'Send now' without adding a note first",
                "  - ❌ FORBIDDEN: NEVER click 'Send invitation' without adding a note first",
                "  - ✅ REQUIRED: You MUST find and click the 'Add a note' link/button",
                "  - The 'Add a note' option may be a small link or button - look carefully for it",
                "  - After clicking 'Add a note', a text box will appear for you to type the message",
                "  - ONLY after you have typed a personalized message can you click 'Send'",
                "  - If the dialog does not have an 'Add a note' option at all, press ESC to close and skip this person",
                "  - Now read their profile information: name, current role, company, and any visible experience or skills",
                "  - Confirm the text box is open and ready for typing (you should see a cursor)",
                ...
                "  - Verify the personalized message is visible in the text box",
                "  - Now and ONLY now, click the 'Send' button to send the connection WITH the note",
                "  - Wait for the dialog to close and confirmation that request was sent",
                "  - Increment your counter by 1 (you've successfully sent a personalized connection request)",
