    ...
    async def execute_linkedin_outreach(
        ...
        try:
            ...
            todos = [
                ...
                f"  - Type a personalized message: 'Hi [Name], I hope this message finds you well. I came across your profile while researching {company}, and I'm really impressed by the work you and the team are doing. I'm currently exploring the {position} position at {company} and would love to connect for a brief conversation to learn more about the role and the team culture. Would you be open to a quick chat at your convenience? Best regards'",
                "  - Click 'Send' or 'Send invitation' to send the connection request",
