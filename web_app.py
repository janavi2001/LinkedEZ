    ...
    async def execute_linkedin_outreach(
        ...
        try:
            ...
            todos = [
                ...
                "  - ABSOLUTE RULE: NEVER EVER click 'Send without a note', 'Send now', or 'Send invitation' button",
                "  - You MUST ONLY click the 'Add a note' button - this is NON-NEGOTIABLE",
                "  - Wait for the 'Add a note' button to appear in the dialog",
                "  - Click ONLY on 'Add a note' to open the text field for personalized message",
                "  - If you cannot find 'Add a note' button, close the dialog and skip this person",
                "  - NEVER proceed without adding a personalized note - this is mandatory",
